...
Unify auth center has no README describing its purpose; its manifest (Dockerfile, go.mod, go.sum) marks it as a Docker and Go codebase, built with Go.
